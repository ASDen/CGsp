...
public:
	...
	Box_3():length(25.0),width(25.0),height(25.0),width_Seg(1),length_Seg(1),height_Seg(1)
	{}

	//Set the parameters with user defined values
	Box_3(double l,double w,double h,int x,int y,int z):length(l),width(w),height(h),width_Seg(x),length_Seg(y),height_Seg(z)
	{}
	...
	Polyhedron Draw()
	{
		...
		Halfedge_handle* arr_lL = new Halfedge_handle[height_Seg];
		Halfedge_handle* arr_lR = new Halfedge_handle[height_Seg];
