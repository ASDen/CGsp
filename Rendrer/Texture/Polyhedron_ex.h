...
class My_facet : public CGAL::HalfedgeDS_face_base<Refs, T,CGAL::Polyhedron_traits_with_normals_3<My_kernel>::Plane_3>
{
public:

    typedef My_kernel::Vector_3 Vector_3;
    typedef My_kernel::Point_3  Point_3;
	//typedef My_kernel::Plane_3  Plane;
...
class Polyhedron_ex : public CGAL::Polyhedron_3< CGAL::Polyhedron_traits_with_normals_3<My_kernel> ,My_items   >
{
public:
