...
int main( int argc, char **argv )
{
	...
	for(int i=0;i<10;i++)
	{
	PolyhedronNode* c1 = new PolyhedronNode(s,osg::Vec3(50,50,2+i*8));
	...
	/*PolyhedronNode* cxy = new PolyhedronNode(s4,osg::Vec3(50,50,36));
	...
	c3->Actor = XTorus::Construct(pxm.gScene,c3,8);
	c3->WireFrame = false;
