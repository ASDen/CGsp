...
int main( int argc, char **argv )
{
	...
	Spring_3* s4 = new Spring_3(10,2.5,40,3,20,30);
	//Torus_3* s4 = new Torus_3(10,3,0,0,10,20);
	...
	/*PolyhedronNode* cx = new PolyhedronNode(s4,osg::Vec3(50,50,100));
	...
	PolyhedronNode* c3 = new PolyhedronNode(s4,osg::Vec3(50,50,200));
	c3->Actor = XSpring::Construct(pxm.gScene,pxm.gPhysicsSDK,c3);
	c3->WireFrame = false;
